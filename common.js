...
const uiText = {
  en: {
    pageTitle: { profile: "FinMate - Profile", dashboard: "FinMate - Dashboard", adviser: "FinMate - Adviser", planner: "FinMate - Planner", scheme: "FinMate - Scheme Finder" },
    currentView: { profile: "Profile", dashboard: "Dashboard", adviser: "Adviser", planner: "Planner", scheme: "Scheme Finder" },
    healthLabels: { strong: "Strong", stable: "Stable", needsAttention: "Needs attention" },
    months: "months",
    labels: {
      "hero-eyebrow": "FinMate", "hero-title": "Profile first. Then guided money decisions.", "hero-text": "Create your FinMate profile first. After that, the dashboard and tools will unlock.",
      "flow-label": "App Flow", "language-label": "Language", "flow-step1-label": "Step 1", "flow-step1-value": "Profile", "flow-step2-label": "Step 2", "flow-step2-value": "Dashboard", "flow-step3-label": "Step 3", "flow-step3-value": "3 Tools", "flow-current-label": "Current View",
      "nav-profile": "Profile", "nav-dashboard": "Dashboard", "nav-adviser": "Adviser", "nav-planner": "Planner", "nav-schemes": "Scheme Finder",
      "profile-step-kicker": "Step 1", "profile-title": "Create financial profile", "profile-pill": "Start Here", "profile-copy": "Fill your details first. Only after creating the profile can you move to the dashboard and other tools.", "profile-submit": "Create Profile",
      "label-name": "Full name", "label-age": "Age", "label-income": "Monthly income (INR)", "label-expenses": "Monthly expenses (INR)", "label-savings": "Current savings (INR)", "label-location": "Location", "label-risk": "Risk tolerance", "label-goal": "Primary goal",
      "dashboard-step-kicker": "Step 2", "dashboard-title": "Dashboard", "dashboard-user-label": "User", "dashboard-goal-label": "Primary goal", "dashboard-location-label": "Location", "monthly-surplus-label": "Monthly surplus", "emergency-runway-label": "Emergency runway", "recommended-sip-label": "Recommended SIP", "health-score-label": "Health score", "dashboard-module-kicker": "Step 3", "dashboard-modules-title": "Choose one module",
      "card-adviser-span": "Adviser", "card-adviser-title": "Chat with a financial assistant", "card-adviser-copy": "Ask focused questions about savings, investing, and wealth building.",
      "card-planner-span": "Planner", "card-planner-title": "Create a goal-based plan", "card-planner-copy": "Estimate monthly contributions and practical actions for each goal.",
      "card-scheme-span": "Scheme Finder", "card-scheme-title": "Find relevant government schemes", "card-scheme-copy": "Match schemes using your profile, goal, and preference filters.",
      "adviser-kicker": "Module 1", "adviser-title": "Adviser", "adviser-pill": "Guided Q&A", "mode-investing": "Investing", "mode-saving": "Saving", "mode-growing": "Growing Wealth", "adviser-intro": "Choose one mode and ask from those topics only.", "ask-button": "Ask",
      "planner-kicker": "Module 2", "planner-title": "Planner", "planner-pill": "Goal Plan", "planner-copy": "Plan for investments, trips, education, emergency fund, gadgets, or other large expenses.", "planner-type-label": "Planning type", "planner-target-label": "Target amount (INR)", "planner-timeline-label": "Timeline (years)", "plan-button": "Calculate plan", "planner-result-investment-label": "Required monthly investment", "planner-result-mix-label": "Suggested mix", "planner-result-insight-label": "Planner insight", "planner-result-action-label": "Suggested action", "planner-result-priority-label": "Priority level", "planner-result-suggestion-label": "Extra suggestion",
      "scheme-kicker": "Module 3", "scheme-title": "Scheme Finder", "scheme-pill": "Eligibility", "scheme-copy": "Use your profile and extra filters to find the most relevant government support.", "scheme-goal-label": "Goal focus", "scheme-occupation-label": "Occupation type", "scheme-gender-label": "Gender", "scheme-tax-label": "Tax preference", "scheme-button": "Find Schemes", "back-dashboard": "Back to Dashboard"
    },
    placeholders: { name: "Enter your full name", "chat-input": "Ask a question from the selected mode" },
    selectOptions: {
  ...
  hi: {
    pageTitle: { profile: "फिनमेट - प्रोफ़ाइल", dashboard: "फिनमेट - डैशबोर्ड", adviser: "फिनमेट - सलाहकार", planner: "फिनमेट - प्लानर", scheme: "फिनमेट - योजना खोजक" },
    currentView: { profile: "प्रोफ़ाइल", dashboard: "डैशबोर्ड", adviser: "सलाहकार", planner: "प्लानर", scheme: "योजना खोजक" },
    healthLabels: { strong: "मजबूत", stable: "स्थिर", needsAttention: "ध्यान चाहिए" },
    months: "महीने",
    labels: {
      "hero-eyebrow": "फिनमेट", "hero-title": "पहले प्रोफ़ाइल। फिर सही पैसों के फैसले।", "hero-text": "पहले अपनी फिनमेट प्रोफ़ाइल बनाइए। उसके बाद ही डैशबोर्ड और बाकी टूल खुलेंगे।",
      "flow-label": "ऐप फ्लो", "language-label": "भाषा", "flow-step1-label": "स्टेप 1", "flow-step1-value": "प्रोफ़ाइल", "flow-step2-label": "स्टेप 2", "flow-step2-value": "डैशबोर्ड", "flow-step3-label": "स्टेप 3", "flow-step3-value": "3 टूल", "flow-current-label": "वर्तमान स्क्रीन",
      "nav-profile": "प्रोफ़ाइल", "nav-dashboard": "डैशबोर्ड", "nav-adviser": "सलाहकार", "nav-planner": "प्लानर", "nav-schemes": "योजना खोजक",
      "profile-step-kicker": "स्टेप 1", "profile-title": "वित्तीय प्रोफ़ाइल बनाएँ", "profile-pill": "यहीं से शुरू करें", "profile-copy": "पहले अपनी जानकारी भरें। प्रोफ़ाइल बनने के बाद ही डैशबोर्ड और बाकी टूल खुलेंगे।", "profile-submit": "प्रोफ़ाइल बनाएँ",
      "label-name": "पूरा नाम", "label-age": "उम्र", "label-income": "मासिक आय (INR)", "label-expenses": "मासिक खर्च (INR)", "label-savings": "वर्तमान बचत (INR)", "label-location": "स्थान", "label-risk": "जोखिम स्तर", "label-goal": "मुख्य लक्ष्य",
      "dashboard-step-kicker": "स्टेप 2", "dashboard-title": "डैशबोर्ड", "dashboard-user-label": "उपयोगकर्ता", "dashboard-goal-label": "मुख्य लक्ष्य", "dashboard-location-label": "स्थान", "monthly-surplus-label": "मासिक बचत शेष", "emergency-runway-label": "इमरजेंसी रनवे", "recommended-sip-label": "सुझाई गई SIP", "health-score-label": "हेल्थ स्कोर", "dashboard-module-kicker": "स्टेप 3", "dashboard-modules-title": "एक मॉड्यूल चुनें",
      "card-adviser-span": "सलाहकार", "card-adviser-title": "वित्तीय सहायक से बात करें", "card-adviser-copy": "बचत, निवेश और धन वृद्धि से जुड़े सवाल पूछें।",
      "card-planner-span": "प्लानर", "card-planner-title": "लक्ष्य आधारित योजना बनाएँ", "card-planner-copy": "हर लक्ष्य के लिए मासिक राशि और व्यावहारिक कदम देखें।",
      "card-scheme-span": "योजना खोजक", "card-scheme-title": "उपयुक्त सरकारी योजनाएँ खोजें", "card-scheme-copy": "प्रोफ़ाइल, लक्ष्य और पसंद के अनुसार योजनाएँ मिलाएँ।",
      "adviser-kicker": "मॉड्यूल 1", "adviser-title": "सलाहकार", "adviser-pill": "मार्गदर्शित सवाल-जवाब", "mode-investing": "निवेश", "mode-saving": "बचत", "mode-growing": "धन वृद्धि", "adviser-intro": "एक मोड चुनें और उसी विषय से जुड़े सवाल पूछें।", "ask-button": "पूछें",
      "planner-kicker": "मॉड्यूल 2", "planner-title": "प्लानर", "planner-pill": "लक्ष्य योजना", "planner-copy": "निवेश, यात्रा, शिक्षा, इमरजेंसी फंड, गैजेट या बड़े खर्च के लिए योजना बनाएँ।", "planner-type-label": "योजना का प्रकार", "planner-target-label": "लक्ष्य राशि (INR)", "planner-timeline-label": "समय सीमा (वर्ष)", "plan-button": "योजना निकालें", "planner-result-investment-label": "ज़रूरी मासिक निवेश", "planner-result-mix-label": "सुझाया गया मिश्रण", "planner-result-insight-label": "प्लानर इनसाइट", "planner-result-action-label": "सुझाया गया कदम", "planner-result-priority-label": "प्राथमिकता स्तर", "planner-result-suggestion-label": "अतिरिक्त सुझाव",
      "scheme-kicker": "मॉड्यूल 3", "scheme-title": "योजना खोजक", "scheme-pill": "पात्रता", "scheme-copy": "अपनी प्रोफ़ाइल और अतिरिक्त फ़िल्टर से सबसे उपयुक्त सरकारी सहायता खोजें।", "scheme-goal-label": "लक्ष्य फोकस", "scheme-occupation-label": "पेशा प्रकार", "scheme-gender-label": "लिंग", "scheme-tax-label": "टैक्स पसंद", "scheme-button": "योजनाएँ खोजें", "back-dashboard": "डैशबोर्ड पर वापस जाएँ"
    },
    placeholders: { name: "अपना पूरा नाम लिखें", "chat-input": "चुने गए मोड से सवाल पूछें" },
    selectOptions: {
...
function loadState() {
  try {
    ...
    return parsed ? { ...defaultState, ...parsed, profile: { ...defaultState.profile, ...(parsed.profile || {}) }, schemePreference: { ...defaultState.schemePreference, ...(parsed.schemePreference || {}) } } : JSON.parse(JSON.stringify(defaultState));
  } catch {
...
state.profileCompleted = hasCompletedProfile(state.profile);

function hasActiveProfileSession() {
  try {
    return sessionStorage.getItem("finmate-profile-session") === "true";
  } catch {
    return false;
  }
}

function setActiveProfileSession(value) {
  try {
    if (value) {
      sessionStorage.setItem("finmate-profile-session", "true");
    } else {
      sessionStorage.removeItem("finmate-profile-session");
    }
  } catch {
    // Ignore session storage errors in static browser previews.
  }
}
...
function updateNav(page) {
  ...
  document.querySelectorAll(".nav-chip").forEach((link) => {
    ...
    const isLocked = !(hasCompletedProfile(state.profile) && hasActiveProfileSession()) && lockedPages.includes(target);
...
function bindLockedNav() {
  ...
  document.querySelectorAll(".nav-chip").forEach((link) => {
    link.addEventListener("click", (event) => {
      const target = link.dataset.page;
      if (!(hasCompletedProfile(state.profile) && hasActiveProfileSession()) && lockedPages.includes(target)) {
...
function enforceAccess(page) {
  if (!(hasCompletedProfile(state.profile) && hasActiveProfileSession()) && page !== "profile") {
...
function basePageSetup(page, rerender) {
  enforceAccess(page);
  applyTranslations(page);
  updateNav(page);
  bindLockedNav();
